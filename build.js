	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'form',
					{ className: 'searchBar', onSubmit: function onSubmit(event) {
							return _this3.onSubmit(event);
						} },
					React.createElement('label', { id: 'searchText', htmlFor: 'searchText' }),
					React.createElement('input', _defineProperty({
						type: 'text',
						id: 'searchText',
						value: true, placeholder: 'Search by user name',
